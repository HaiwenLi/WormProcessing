function GroupExtractBasedTracking(frame_seq,tracking_index,FlouType,Folder,posFolder)
    ...
    Neuron_stack = struct('node',Stack_node);  % layer_num, node. layer_num+1 lay  
%     ers in fact
    layer_num = 0;
