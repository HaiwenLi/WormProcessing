function track_single_neuron(ImageFolder,anchor_filename,anchor_start,frame_list,initial_pos,output_name) 
% Track single neuron
% Input:
...
for n = 2:Tracking_Length
    ...
    [Ax_tempt(1),Ay_tempt(1)] = update_center(gross_pos(1),gross_pos(2),...
        search_interval,intensity_ratio,Wimage);
    [Ax_tempt(2),Ay_tempt(2)] = update_center(Ax_tempt(1),Ay_tempt(1),search_interval-3,intensity_ratio,Wimage);
%     [Ax_tempt(3),Ay_tempt(3)] = update_center(Ax_tempt(2),Ay_tempt(2),search_interval,intensity_ratio,Wimage);
